...
const LearnSkillsPage = ({ setUserData }) => {
  ...
  try {
    ...
    const response = await fetch(`http://localhost:5000/tolearnpreferences/${userId}`, {
      method: "PATCH",
      headers: {
    ...
    <div style={styles.wrapper}>
      <div style={styles.container}>
        <h2 style={styles.heading}>
          Which topics or areas do you want to learn?
        </h2>
...
const styles = {
  wrapper: {
    ...
    alignItems: "center",
    minHeight: "100vh",
    background: "linear-gradient(135deg, #3d1f2b, #58323f, #7a4351)",
    padding: "20px",
  },
  container: {
    padding: "40px 30px",
