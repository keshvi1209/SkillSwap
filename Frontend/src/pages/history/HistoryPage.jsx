              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div>
                  ...
                  <p className="text-gray-400">
                    Track your learning journey and teaching sessions
                  </p>
                </div>
              ...
              {meetings.length === 0 ? (
                ...
                >
                  ...
                  <p className="text-gray-400 max-w-md mx-auto mb-6">
                    You haven't scheduled any sessions yet. Connect with others
                  ...
                  {filteredMeetings.map((meet) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`relative overflow-hidden group rounded-2xl border transition-all duration-300 ${
                          isPast
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex flex-wrap items-center gap-4 text-sm text-gray-400">
                              ...
                              <div className="flex items-center gap-1.5">
                                ...
                                {" - "}
                                {new Date(meet.endTime).toLocaleTimeString(
                                  undefined,
                                  { hour: "2-digit", minute: "2-digit" },
                                )}
                              </div>
