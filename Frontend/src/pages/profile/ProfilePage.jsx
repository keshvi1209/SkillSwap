      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header className="mb-8 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
            ...
            <span className="text-sm font-medium text-gray-200">Premium Account</span>
          </div>
        </header>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gray-900/60 backdrop-blur-xl shadow-xl p-6">
              ...
              <div className="flex items-end gap-3 mb-4">
                <span className="text-5xl font-black text-white tracking-tighter">4.8</span>
                <div className="flex flex-col mb-1">
                  ...
                  <span className="text-xs text-gray-400 font-medium ml-0.5">based on 124 reviews</span>
                </div>
              </div>
